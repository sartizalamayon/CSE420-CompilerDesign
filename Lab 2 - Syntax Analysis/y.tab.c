...
static const yytype_int8 yyrhs[] =
{
      ...
      34,    -1,    11,    -1,    12,    -1,    14,    -1,    49,    35,
      36,    -1,    49,    35,    36,    32,    37,    33,    -1,    36,
      -1,    36,    32,    37,    33,    -1,    51,    -1,    50,    51,
      -1,    47,    -1,    52,    -1,    46,    -1,     5,    28,    52,
      52,    54,    29,    51,    -1,     3,    28,    54,    29,    51,
      -1,     3,    28,    54,    29,    51,     4,    51,    -1,     6,
      28,    54,    29,    51,    -1,    19,    28,    36,    29,    34,
      -1,    10,    54,    34,    -1,    34,    -1,    54,    34,    -1,
...
{
       0,    29,    29,    35,    41,    49,    55,    63,    69,    77,
      83,    89,    95,   103,   109,   117,   126,   132,   138,   147,
     153,   159,   165,   173,   179,   187,   193,   199,   205,   211,
     217,   223,   229,   235,   243,   249,   257,   263,   271,   277,
     285,   291,   299,   305,   313,   319,   327,   333,   341,   347,
     353,   361,   367,   373,   379,   385,   391,   397,   405,   412,
     419,   425
};
#endif
...
static const yytype_uint8 yystos[] =
{
      ...
      32,    36,    31,    51,    22,    23,    25,    34,    26,    20,
      24,    21,    36,    33,    54,    52,    54,    34,    36,    29,
      55,    61,    62,    54,    55,    56,    58,    57,    59,    29,
      52,    29,    29,    29,    35,    33,    51,    54,    51,    34,
      55,     4,    29,    51,    51
};
...
#line 230 "24341270.y"
    {
        ...
        (yyval) = new symbol_info("printf(" + (yyvsp[(3) - (5)])->getname() + ");", "stmnts");
    }
    break;
...
#line 236 "24341270.y"
    {
        ...
        (yyval) = new symbol_info("return " + (yyvsp[(2) - (3)])->getname() + ";", "stmnts");
    }
    break;
